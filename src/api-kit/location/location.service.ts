...
export class LocationService {
  ...
  getAutoCompleteCounties(q?:string, searchby?:string, searchvalue?:string, city?:string, country ) {
    var oApiParam = {
      name: 'location',
      suffix: '/counties',
      oParam: {q:q, searchby:searchby, searchvalue:searchvalue, city:city, cc:country },
      method: 'GET'
    };
