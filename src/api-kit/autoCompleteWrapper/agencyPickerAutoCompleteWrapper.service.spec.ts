import { AgencyPickerAutoCompleteWrapper } from "./agencyPickerAutoCompleteWrapper.service";
...
describe("api-kit/autoCompleteWrapper/agencyPickerAutoCompleteWrapper.service.spec.ts", ()=>{
    let service: AgencyPickerAutoCompleteWrapper;

    beforeEach(()=>{
        service = new AgencyPickerAutoCompleteWrapper(<any>fhServiceMock);
    });
