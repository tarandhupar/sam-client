...
import {SamAlertComponent} from "./sam-alert/sam-alert.component";
 ...
 */
@NgModule({
  declarations: [ SamSelectComponent, SamCheckboxesComponent, SamRadioButtonsComponent, SamSearchbarComponent, SamBannerComponent, SamHeaderComponent, LabelWrapper, FieldsetWrapper, SamStickyComponent, SamAlertComponent ],
  imports: [ BrowserModule, FormsModule, HttpModule, RouterModule ],
  exports: [ SamSelectComponent, SamCheckboxesComponent, SamRadioButtonsComponent,SamSearchbarComponent,SamBannerComponent, SamHeaderComponent, SamStickyComponent, SamAlertComponent  ],
  providers: [ ]
})
