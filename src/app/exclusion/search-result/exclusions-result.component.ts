  ...
  template: `
      <p>
    	...
    	<div class="usa-width-two-thirds">
          ...
          <li><strong>Address: </strong><span>{{ data.address.streetAddress }}{{data.address.city=="" || data.address.city==null || data.address.streetAddress=="" || data.address.streetAddress==null ? '' : ','}} {{ data.address.city }}{{data.address.state=="" || data.address.state==null || data.address.city=="" || data.address.city==null ? '' : ','}} {{ data.address.state}} {{data.address.zip}}</span></li>
        </ul>
    	</div>
