...
@Component({
  templateUrl: './system-migrations.component.html',
  providers: [
    IAMService
  ]
})
export class SystemMigrationsComponent {
  @ViewChild('form') form;
  @ViewChild('title') title;

  private differ;
  private store = {
    title: 'System Account Role Migrations',
    legacy: [],
    migrations: [],
    systems: [],
    roles: {},
  ...
  private states = {
    ...
    confirm: {
      type: 'success',
      message: 'System Account Successfully Migrated',
      show: false
    }
  }
