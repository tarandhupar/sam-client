...
export class SubscriptionsComponent {
  ...
  msgSortOptions = [{label:'Last Modified', name:'Last Modified', value:'date'}, {label:'Record ID', name:'Record ID', value:'recordId'}, {label:'Type', name:'Type', value:'type'}];
