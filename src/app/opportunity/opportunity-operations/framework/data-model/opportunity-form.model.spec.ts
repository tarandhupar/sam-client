...
describe('src/app/opportunity/opportunity-operations/framework/data-model/opportunity-form.model.spec.ts', () => {
  ...
  it('get description returns description', () => {
    ...
    dataModel = new OpportunityFormViewModel(_opportunity);
    expect(dataModel.description).toEqual("test description");
  });
  ...
  it('set description returns updated description', () => {
    ...
    dataModel = new OpportunityFormViewModel(_opportunity);
    dataModel.description = 'test description1';
    expect(dataModel.description).toEqual("test description1");
  });
});
