...
export class PartnersComponent {
  ...
  private data:any = [
      ...
      },
      {
        ...
        content:"A comprehensive website to stay-up-to-date on the latest developments in federal acquisitions and electronically search versions from the past and present. SAM.gov also provides a catalog of Federal Acquisitions but allows the user to create an account, maintain information, and apply for funding.",
      ...
      {
        title:"Benefits.gov",
        content:"The official website for information about benefits available from the U.S. government.  SAM.gov provides the benefits program content.",
